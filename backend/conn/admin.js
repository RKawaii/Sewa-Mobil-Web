...
module.exports = {
  ...
  get: (req, res) => {
    ...
    switch (path) {
      ...
      case '/sewa':
        sql =
          'SELECT sewa.id AS main_id,jenis_kendaraan.*,sewa.*,mobil.*,user.* FROM sewa join jenis_kendaraan on sewa.id_jenis_mobil = jenis_kendaraan.id join user on user.id = sewa.id_user  ';
        thru = true;
        break;
      case '/user':
      ...
      case '/transaksi':
        sql =
          'SELECT sewa.id AS main_id, transaksi.*,jenis_kendaraan.*,sewa.*,mobil.*,user.*  FROM sewa join transaksi on transaksi.id_sewa = sewa.id  join user on user.id = sewa.id_user join mobil on mobil.id_jenis_mobil = jenis_kendaraan.id ';
        thru = true;
        break;
      case '/staff':
      ...
      case '/mobil/:id':
        ...
        break;
      case '/sewa/:id':
        sql = `SELECT sewa.id AS main_id,jenis_kendaraan.*,sewa.*,user.* FROM sewa join jenis_kendaraan on sewa.id_jenis_mobil = jenis_kendaraan.id join user on user.id = sewa.id_user where sewa.id=${req.params.id} `;
        thru = true;
        break;
      case '/user/:id':
        ...
        break;
      case '/transaksi/:id':
        sql = `SELECT transaksi.id AS main_id, transaksi.*,jenis_kendaraan.*,sewa.*,user.*  FROM sewa join transaksi on transaksi.id_sewa = sewa.id join jenis_kendaraan on sewa.id_jenis_mobil = jenis_kendaraan.id join user on user.id = sewa.id_user  where id=${req.params.id} `;
        thru = true;
        break;
      case '/staff/:id':
