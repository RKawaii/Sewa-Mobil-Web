...
module.exports = {
  ...
  get: (req, res) => {
    ...
    switch (path) {
      ...
      case '/sewa':
        sql =
          'SELECT sewa.id,jenis_kendaraan.jenis_mobil, user.email, sewa.penggunaan_supir, sewa.mulai_sewa, sewa.akhir_sewa, sewa.lokasi_pickup, sewa.lokasi_destinasi FROM sewa join jenis_kendaraan on sewa.id_jenis_mobil = jenis_kendaraan.id join user on user.id = sewa.id_user ';
        thru = true;
        break;
      case '/user':
      ...
      case '/transaksi':
        sql =
          'SELECT sewa.*, transaksi.kode_transaksi, transaksi.biaya, transaksi.status_transaksi FROM sewa join transaksi on transaksi.id_sewa = sewa.id ';
        thru = true;
        break;
      case '/staff':
      ...
      case '/mobil/:id':
        ...
        break;
      case '/sewa/:id':
        sql = `SELECT sewa.id,jenis_kendaraan.jenis_mobil, user.email, sewa.penggunaan_supir, sewa.mulai_sewa, sewa.akhir_sewa, sewa.lokasi_pickup, sewa.lokasi_destinasi FROM sewa join jenis_kendaraan on sewa.id_jenis_mobil = jenis_kendaraan.id join user on user.id = sewa.id_user where id=${req.params.id} `;
        thru = true;
        break;
      case '/user/:id':
        ...
        break;
      case '/transaksi/:id':
        sql = `SELECT sewa.*, transaksi.kode_transaksi, transaksi.biaya, transaksi.status_transaksi FROM sewa join transaksi on transaksi.id_sewa = sewa.id where id=${req.params.id} `;
        thru = true;
        break;
      case '/staff/:id':
